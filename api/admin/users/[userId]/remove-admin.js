...
const logger = {
  info: (...args) => !process.env.VERCEL && console.log('[Admin/RemoveAdmin]', ...args),
  debug: (...args) => !process.env.VERCEL && console.debug('[Admin/RemoveAdmin]', ...args),
  warn: (...args) => console.warn('[Admin/RemoveAdmin]', ...args),
  error: (...args) => console.error('[Admin/RemoveAdmin]', ...args)
};
